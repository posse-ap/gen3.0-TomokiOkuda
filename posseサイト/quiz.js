...
const ALL_QUIZ = [
  {
    id: 1,
    question: '日本のItzinnzaiga2030年には最大どれくらい不足すると言われているでしょうか？',
    answers: ['約28万人', '約79万人', '約183万人'],
    correctNumber: 1,
    note: '経済産業省 2019年3月 - IT人材需要に関する調査'
  },
  {
    id: 2,
  ...
  return `<section class="p-quiz-box js-quiz" data-quiz="${questionNumber}">
      <div class="p-quiz-box__question">
        ...
        <figure class="p-quiz-box__question__image">
          <img src="./assets-ph1-website-main/img/quiz/img-quiz0${quizItem.id}.png" alt="">
        </figure>
      </div>
